...
namespace VLCplayer
{
    public partial class Form1 : Form
    {
        ...
        {
            openFileDialog1.Filter = "Video Files (*.avi, *.wmv, *.mp4)|*.avi;*.wmv;*.mp4";
        ...
        private void btn_Play_Click(object sender, EventArgs e)
        {
            if (txt_File.Text != "")
            {
                ...
                if (btn_Play.Text == "播放")
                {
                    axVLCPlugin21.playlist.add(txt_File.Text, null, null);
                }
                else if (btn_Play.Text == "開始串流")
                {
                    axVLCPlugin21.playlist.add(txt_File.Text, null,
        ...
        private void txt_IPAddress_TextChanged(object sender, EventArgs e)
        {
